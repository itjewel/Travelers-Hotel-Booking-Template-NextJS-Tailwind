                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    ...
                    {/* ------------------ 1 --------------------- */}
                                  
                      {
                        !isHost && 
                      <> 
                        <button onClick={handleSwitch} className="btn p-2 rounded-full text-white bg-[#5043d8] text-sm font-semibold ">Switch to host mode</button>   
                       <Link
                        href={"/account"}
...

                    {
                      isHost && 
                       <> 
                         <button onClick={handleSwitch} className="btn p-2 rounded-full text-white bg-[#5043d8] text-sm font-semibold ">Switch to guest mode</button>   
                       <Link
                        href={"/account"}
                        className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                        onClick={() => close()}
                      ...
                      >
                        <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        <TbLayoutDashboard size={22} className="mr-2 ml-0.5" />
                        </div>
                        <div className="ml-2">
                          <p className="text-sm font-medium ">{"Host Dashboard"}</p>
                        </div>
                      </Link> 
